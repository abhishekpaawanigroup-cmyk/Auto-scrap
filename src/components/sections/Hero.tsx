  ...
  return (
    <section className="relative overflow-hidden bg-ink-950">
      <Image
        ...
        alt="Vehicle recovered at a certified recycling facility"
        fill
        priority
      ...
      <Container className="relative z-10 grid grid-cols-1 gap-16 py-20 lg:grid-cols-[1.15fr_0.85fr] lg:gap-10 lg:py-28">
        <div className="flex flex-col justify-center">
          ...
          >
            ...
            <br />
            <span className="text-gradient-primary">Into Instant Value</span>
          </motion.h1>
          ...
          >
            {benefits.map(({ icon: Icon, label }) => (
              <div key={label} className="flex shrink-0 items-center gap-2 text-xs text-ink-300 sm:gap-2.5 sm:text-sm">
