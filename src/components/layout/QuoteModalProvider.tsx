          ...
          >
            ...
            >
              <button
                ...
                onClick={closeQuoteModal}
                aria-label="Close"
                className="absolute -right-3 -top-3 z-10 flex h-9 w-9 items-center justify-center rounded-full bg-white text-ink-700 shadow-[var(--shadow-premium-lg)] transition-colors hover:text-primary-600"
              >
                <X className="h-4 w-4" />
              </button>
